                                    ...
                                    <div class="row p-t-20">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="registrationNumber" value="{{ $vehicle->registrationNumber }}" name="registrationNumber" class="form-control" placeholder="Enter Vehicle Registration Number" maxlength="6">
