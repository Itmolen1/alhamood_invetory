                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control companyType" id="companyType" name="companyType" placeholder="Company type">
                                            </div>
                                        </div>
                                        <!--/span-->
                                        <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control paymentType" id="paymentType" name="paymentType" placeholder="Payment type">
                                            </div>
                                        </div>
                                        <!--/span-->
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control paymentType" id="paymentTerm" name="paymentTerm" placeholder="Payment Term">
                                            </div>
                                        </div>
                                        <!--/span-->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="TRNNumber" id="TRNNumber" class="form-control TRNNumber" placeholder="Enter TRN Number">
                                            </div>
                                        </div>
                                        <!--/span-->
