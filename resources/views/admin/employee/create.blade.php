                                    ...
                                    <div class="row p-t-20">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="emergencyContactNumber" name="emergencyContactNumber" class="form-control" placeholder="Emergency Contact Number">
                                            </div>
                                        </div>
                                    </div>
                                    <!--/row-->
                                    ...
                                    <div class="row p-t-20">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="passportNumber" name="passportNumber" class="form-control" placeholder="Enter Passport Number">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
