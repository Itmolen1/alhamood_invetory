...
@section('title', 'Expense Analysis By Supplier')
...
@section('content')
    ...
    <div class="page-wrapper">
        <div class="container-fluid">
            ...
            <h2 class="card-title">Expense Analysis By Supplier</h2>

            <form action="{{ URL('ViewExpenseAnalysisBySupplier') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-3">
