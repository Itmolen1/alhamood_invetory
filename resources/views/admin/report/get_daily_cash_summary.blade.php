...
@section('content')
    ...
    <div class="page-wrapper">
        <div class="container-fluid">
                ...
                <div class="col-md-7 align-self-center text-right">
                    <div class="d-flex justify-content-end align-items-center">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Daily Cash</li>
                        </ol>
                       </div>
                </div>
            </div>
            ...
            <form id="report_form" method="post" action="{{ route('PrintDailyCashSummary') }}" enctype="multipart/form-data">
                @csrf
            <div class="row">
                <div class="col-md-4">
