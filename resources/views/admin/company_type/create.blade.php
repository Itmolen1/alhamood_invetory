        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Company Type  Registration</h4>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header bg-info">
                            <h4 class="m-b-0 text-white">Company Types</h4>
                        </div>
                        <div class="card-body">
                            <form method="post" action="{{ route('company_types.store') }}">
                                @csrf
                                <div class="form-body">
                                    ...
                                    <div class="row p-t-20">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="control-label">Company Type Name</label>
                                                <input type="text" id="Name" name="Name" class="form-control" placeholder="Enter Company Type Name">
                                        </div>
                                        </div>
