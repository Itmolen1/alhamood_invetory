...
@section('title', 'Payment term Edit')
        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Payment term  Modification</h4>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" action="{{ route('payment_terms.update',$payment_term->id) }}">
                                @csrf
                                @method('PUT')
                                <div class="form-body">
                                    ...
                                    <div class="row p-t-20">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="Name" name="Name" value="{{$payment_term->Name}}" class="form-control" placeholder="Payment Term">
                                            </div>
                                        </div>
