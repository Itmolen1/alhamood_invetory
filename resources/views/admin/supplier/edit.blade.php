                                    ...
                                    <div class="row p-t-20">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="companyName" name="companyName" class="form-control" placeholder="Enter Customer Company Name">
                                            </div>
                                        </div>
                                        <!--/span-->
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="representive" name="representive" class="form-control" placeholder="Enter Owner/Representative Name">
                                            </div>
                                        </div>
                                        <!--/span-->
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control custom-select" name="companyType">
                                                    ...
                                                    <option>Bulk Importer</option>
                                                    <option>Whole Sale Trader</option>
