...
@section('content')
                            ...
                            <form action="#">
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <input type="text" class="form-control amount" onkeyup="toWords($('.amount').val())" name="" id="paidAmount" placeholder="Paid Amount">
                                            </div>
                                        </div>
    ...
    <script src="{{ asset('admin_assets/assets/dist/invoice/numberToWords.js') }}"></script>
