...
<head>
    ...
    <title>Dashboard | Al hamood</title>
    <!-- page css -->
    <link href="{{ asset('admin_assets/assets/dist/css/pages/login-register-lock.css') }}" rel="stylesheet">
    <!-- Custom CSS -->
...
<!-- ============================================================== -->
<section id="wrapper">
    <div class="login-register" style="background-image:url({{ asset('admin_assets/assets/images/img/signin.jpg') }});">
        <div class="login-box card">
            <div class="card-body">
                <form class="form-horizontal form-material" id="loginform" action="{{ url('admin') }}">
