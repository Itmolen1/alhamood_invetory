        ...
        if(!empty($data['purchase_details']))
        {
            ...
            $html = '<table border="0.5" cellpadding="5">
                <tr style="background-color: rgb(122,134,216); color: rgb(255,255,255);">
                    ...
                    <th align="center" width="50">PadNO</th>
                    <th align="center" width="40">Unit</th>
                    <th align="center" width="40">Price</th>
                    <th align="center" width="45">Quantity</th>
                    <th align="center" width="35">Tax</th>
...
//                {
                    ...
                    <td align="left" width="50">'.$row[$i]['PadNumber'].'</td>
                    <td align="center" width="40">'.number_format($row[$i]['unit_id'],2,'.',',').'</td>
                    <td align="center" width="45">'.number_format($row[$i]['Price'],2,'.',',').'</td>
                    <td align="center" width="35">'.number_format($row[$i]['Quantity'],2,'.',',').'</td>
            ...
            $html.= '
                <tr color="black">
                    ...
                    <td width="80" align="right" style="border: 1px solid black;">'.number_format($vat_total,2,'.',',').'</td>
                </tr>';
            $html.= '
                <tr color="black">
                    <td width="85" colspan="2" align="right" style="border: 1px solid black;">Grand Total(AED)</td>
                    <td width="80" align="right" style="border: 1px solid black;">'.number_format($grand_total,2,'.',',').'</td>
                </tr>';
            $html.='</table>';
            $pdf::writeHTML($html, true, false, true, false, '');

            $amount_in_words=$this->getUAECurrency($grand_total);
